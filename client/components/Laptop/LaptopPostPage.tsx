...
const LaptopPostPage = ({post}:any) => {
  ...
  {
    Icon: Cpu,
    title: post.platform?.[0]?.gpu,
    subtitle: post.network?.[0]?.technology,
  },
  ];
    ...
    <div className="w-full">
        ...
        <div className="mt-[1vh] md:mt-[1vw] overflow-hidden">
            <div className="flex gap-[.3vh] md:gap-1 items-center md:h-[4vh] lg:h-[5vh] h-[3vh]">
                ...
                <div className="flex flex-col font-semibold cursor-pointer divide-y divide-zinc-200">
                    {[
                    { label: post.maincam?.[0]?.type, value: post.maincam?.[0]?.mp || "N/A", bg: 'bg-green-200' },
                    { label: 'Resolution', value:post.maincam?.[0]?.resolution || "N/A"},
                    { label: 'Features', value: post.maincam?.[0]?.features || "N/A", bg: 'bg-green-200' },
                    { label: 'Videofps', value: post.maincam?.[0]?.videofps || "N/A"},
                    { label: 'Zoom', value: post.maincam?.[0]?.zoom || "N/A", bg: 'bg-green-200' },
                    ].map((item, index) => (
                    <div
                        key={index}
                        className={`text-[1.1vh] md:text-[1vw] lg:text-[1vw] text-zinc-600 px-2 py-1 flex  md:flex-row gap-[.4vh] md:gap-[.4vw] ${
        ...
        <div className="mt-[1vh] md:mt-[1vw] overflow-hidden">
            <div className="flex gap-[.3vh] md:gap-1 items-center md:h-[4vh] lg:h-[5vh] h-[3vh]">
                ...
                <div className="flex flex-col font-semibold cursor-pointer divide-y divide-zinc-200">
                    {[
                    { label: post.frontcam?.[0]?.type, value: post.frontcam?.[0]?.mp || "N/A", bg: 'bg-green-200' },
                    { label: 'Resolution', value:post.frontcam?.[0]?.resolution || "N/A"},
                    { label: 'Features', value: post.frontcam?.[0]?.features || "N/A", bg: 'bg-green-200' },
                    { label: 'Videofps', value: post.frontcam?.[0]?.videofps || "N/A"},
                    ].map((item, index) => (
                    <div
                        key={index}
                        className={`text-[1.1vh] md:text-[1vw] lg:text-[1vw] text-zinc-600 px-2 py-1 flex  md:flex-row gap-[.4vh] md:gap-[.4vw] ${
        ...
        <div className="mt-[1vh] md:mt-[1vw] overflow-hidden">
            <div className="flex gap-[.3vh] md:gap-1 items-center md:h-[4vh] lg:h-[5vh] h-[3vh]">
                ...
                <div className="flex flex-col font-semibold cursor-pointer divide-y divide-zinc-200">
                    ...
                    { label: 'Ir', value:post.features?.[0]?.ir || "N/A"},
                    ].map((item, index) => (
                    <div
                        key={index}
                        className={`text-[1.1vh] md:text-[1vw] lg:text-[1vw] text-zinc-600 px-2 py-1 flex  md:flex-row gap-[.4vh] md:gap-[.4vw] ${
