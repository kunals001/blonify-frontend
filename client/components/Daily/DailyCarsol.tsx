  ...
  return (
    <div>
        <div className="p-[.5vh] md:p-[.5vw] lg:p-[.5vw] relative rounded-xl bg-gradient-to-b from-zinc-100 to-green-200">
            <Link href={`/article/${post?.slug}`} ><ImageKit w={500} h={400} src={post?.coverImg as string} alt={post?.altText as string} className="w-full h-[22vh] md:w-full md:h-[15vw] lg:w-full lg:h-[16vw] rounded-xl object-cover" /></Link>
            ...
            <div className="pt-[.5vh] md:pt-[.5vw] lg:pt-[.4vw] flex gap-[1vh] md:gap-[1vw]  md:justify-start items-center">
                ...
                <span className='text-zinc-500 text-[.9vh] md:text-[.8vw] lg:text-[.8vw] w-[10vh] md:w-[11vw] lg:w-[11vw] font-second '> {post?.createdAt? formatDistanceToNow(new Date(post.createdAt), { addSuffix: true }): 'Unknown'}</span>
            </div>
