...
const PostListItems = ({post}:{post:Post}) => {
  return (
    <div className='w-full flex gap-[1vh] md:gap-[.5vw] lg:gap-[.5vw] relative'>
        ...
        <Link href={`/article/${post?.slug}`} ><ImageKit w={600} h={600} src={post?.coverImg} alt={post?.altText} className="w-[16vh] h-[11.5vh] md:w-[25vw] md:h-[16vw] lg:w-[25vw] lg:h-[16vw] rounded-xl object-cover"/></Link>
