...
const WebHeadline = () => {
  return (
    <div className="headline select-none overflow-hidden flex justify-between items-center">
        ...
        <h2 className="text-xl md:text-[2.5vw] lg:text-[2.5vw] font-semibold text-zinc-700 leading-none flex overflow-hidden">Starts Here – <div 
        className="bg-gradient-to-r from-prime to-emerald-500 text-transparent bg-clip-text"> Blonify.</div></h2>
