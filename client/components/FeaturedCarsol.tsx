  ...
  return (
    <div  className='relative overflow-hidden rounded-xl'>
        <Link href={`/article/${post?.slug}`}><ImageKit w={800} h={800} src={post?.coverImg}
              ...
              <div className="absolute bottom-0 w-full md:h-[5vw] h-[6vh] flex gap-[1vh] rounded-b-xl md:px-[1vw] px-[1vh] md:py-[1vw] py-[1vh] items-center bg-gradient-to-b backdrop-blur-sm from-zinc-100 to-zinc-400">
