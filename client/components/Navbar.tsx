  ...
  return (
    <nav className='z-20 w-full flex items-center h-[6vh] md:h-[4vw] lg:h-[4vw] px-[1vh] md:px-[13vw] lg:px-[15vw] justify-between  gap-[1vw] backdrop-filter backdrop-blur-xl select-none sticky top-0'>
        ...
        <Link href="/"><div className={`nav-logo w-[10vh] hidden md:flex lg:flex md:gap-[.5vw] lg:gap-[.5vw] items-center select-none `}>
            <Image width={50} height={50} src="/logo.svg" alt="logo" className='w-[3.5vh] h-[3.5vh] md:w-[1.9vw] md:h-[1.9vw] lg:w-[1.8vw] lg:h-[1.8vw]' />
        ...
        <Link href="/"><div className={`nav-logo-mobile w-[10vh] flex gap-[1vw] md:hidden lg:hidden items-center select-none transition-all duration-500 ${isSearch ? 'hidden' : 'visible'}`}>
            <Image width={50} height={50} src="/logo.svg" alt="logo" className='w-[3.2vh] h-[3.2vh]'/>
