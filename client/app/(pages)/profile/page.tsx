        ...
        <div className="w-full md:w-[35vw] lg:w-[35vw] p-[1vh] md:p-[1vw] lg:p-[1vw] rounded-xl bg-green-200">
            ...
            <form onSubmit={handleUpdate} className='flex flex-col w-full mt-[1vh] md:mt-[.8vw] lg:mt-[.8vw]'>
                <div className="relative w-full flex items-center justify-center">
                    <input type="name" placeholder={user?.name} value={name} onChange={(e: React.ChangeEvent<HTMLInputElement>) => setName(e.target.value)} className='w-full px-[2.5vh] md:px-[2vw] lg:px-[2vw] outline-none py-[1vh] md:py-[.5vw] lg:py-[.5vw] rounded-xl text-[1.3vh] md:text-[1vw] lg:text-[1vw] bg-zinc-100 border-1 border-prime font-second font-medium text-zinc-700 relative' />
                 ...
                 <div className="relative w-full flex items-center justify-center pt-[.7vh] md:pt-[.5vw] lg:pt-[.5vw]">
                    <input type="password" placeholder={"Set new password"} value={password} onChange={(e: React.ChangeEvent<HTMLInputElement>) => setPassword(e.target.value)} className='w-full px-[2.5vh] md:px-[2vw] lg:px-[2vw] outline-none py-[1vh] md:py-[.5vw] lg:py-[.5vw] rounded-xl text-[1.3vh] md:text-[1vw] lg:text-[1vw] bg-zinc-100 border-1 border-prime font-second font-medium text-zinc-700 relative' />
