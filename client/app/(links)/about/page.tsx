    ...
    <div className='w-full mt-[4vh] md:mt-[2vw] h-[70vh] md:h-screen md:px-[13vw] lg:px-[15vw] md:pt-[2vw] lg:p-[2.1vw] flex flex-col'>
      ...
      <div className="flex flex-col items-center justify-center px-[1vh] md:px-0 lg:px-0 gap-[.7vh] md:gap-[.3vw]">
        <p className='w-full md:w-[30vw] text-[1.3vh] md:text-[1vw]'>
          Welcome to <span className='font-semibold'>Blonify</span> – your go-to place for everything tech!
        </p>

        <p className='w-full md:w-[30vw] text-[1.3vh] md:text-[1vw]'>
          We&rsquo;re here to make your tech journey easier, smarter, and more fun. Whether you&apos;re looking for <span className='font-semibold'>mobile phone reviews, detailed specifications, laptop comparisons,</span> or the latest on <span className='font-semibold'>smartwatches,</span> we&rsquo;ve got you covered. We also provide <span className='font-semibold'>useful online tools</span> to make your daily digital life more productive.
        </p>
        ...
        <p className='w-full md:w-[30vw] text-[1.3vh] md:text-[1vw]'>
          At Blonify Tech, our goal is simple:
        </p>
        ...
        <p className='w-full md:w-[30vw] text-[1.3vh] md:text-[1vw]'>
          We&rsquo;re not here to confuse you with complicated terms. Instead, we want to make tech feel friendly, understandable, and useful for your life.
        </p>
        ...
        <p className='w-full md:w-[30vw] text-[1.3vh] md:text-[1vw]'>
          ...
          <br />
          Let&rsquo;s grow in tech, together.
        </p>
      </div>
    </div>
  );
